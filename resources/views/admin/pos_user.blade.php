  ...
  <body>
                                                        ...
                                                        <div class="modal-body text-left">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-4 mb-4">
                                                                    ...
                                                                    <input type="text" class="form-control form-control-sm" name="phone" value="{{$pos_user->phone}}" required>
                                                                </div>
                                                                <div class="col-md-4 mb-4">
    ...
    <div id="addUser" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
        <div role="document" class="modal-dialog modal-lg">
            <div class="modal-content">
                <form class="validate_form" action="{{url('add_user')}}" method="POST" enctype="multipart/form-data">
                    @csrf
