...
<html>
  <head>
    ...
    <title>DEV POS - Invoice Detail</title>
  </head>
  <body>
    <!-- Header -->
                    ...
                    <div class="col-md-12">
                        <div class="block">
                            <div class="row">
                                ...
                                <div class="col-lg-2">
                                    <p><span class="font-weight-bold">Stock Out Date</span><br>{{$invoice->stock_date}}</p>
                                </div>
                                <div class="col-lg-2">
                                    <p><span class="font-weight-bold">User</span><br>{{$invoice->user}}</p>
                                </div>
                                <div class="col-lg-2">
                                    <p><span class="font-weight-bold">Stock Out Note</span><br>{{$invoice->stock_note}}</p>
                                </div>
                                <div class="col-lg-2">
